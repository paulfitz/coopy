...
void rstats_cmd(void){
  ...
  _ssfossil_printf(" Number of Artifacts: %d\n", n);
  _ssfossil_printf("  %d full text + %d delta blobs\n", (n-m), m);
  if( n>0 ){
    int a, b;
