...
void cmd_test_urlparser(void){
  ...
  url_parse(g.argv[2]);
  for(i=0; i<2; i++){
    _ssfossil_printf("g.urlIsFile    = %d\n", g.urlIsFile);
    _ssfossil_printf("g.urlIsHttps   = %d\n", g.urlIsHttps);
    _ssfossil_printf("g.urlProtocol  = %s\n", g.urlProtocol);
    _ssfossil_printf("g.urlName      = %s\n", g.urlName);
    _ssfossil_printf("g.urlPort      = %d\n", g.urlPort);
    _ssfossil_printf("g.urlDfltPort  = %d\n", g.urlDfltPort);
    _ssfossil_printf("g.urlHostname  = %s\n", g.urlHostname);
    _ssfossil_printf("g.urlPath      = %s\n", g.urlPath);
    _ssfossil_printf("g.urlUser      = %s\n", g.urlUser);
    _ssfossil_printf("g.urlPasswd    = %s\n", g.urlPasswd);
    _ssfossil_printf("g.urlCanonical = %s\n", g.urlCanonical);
    if( i==0 ){
      _ssfossil_printf("********\n");
