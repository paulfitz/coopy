...
if [ "k$1" = "kmingw" ] ; then
    ...
    cmake  -DCMAKE_TOOLCHAIN_FILE=$PWD/../sheet_scm/scripts/mingwin.cmake -DCMAKE_EXE_LINKER_FLAGS="-L $HOME/mingw/install/lib" -DCMAKE_RC_COMPILER=/usr/bin/i586-mingw32msvc-windres -DCMAKE_RC_OUTPUT_EXTENSION=".obj" .. && {
	echo " "
	echo "Successful configuration! Compile with:"
	echo "  cd mingw"
	echo "  make"
