...
int
gnulib_getopt_internal (int argc, char **argv, const char *optstring,
...
{
  return gnulib_getopt_internal (argc, (char **) argv, optstring,
...
{
  return gnulib_getopt_internal (argc, argv, optstring,
                           (const struct option *) 0,
                           (int *) 0,
                           0, 1);
}
