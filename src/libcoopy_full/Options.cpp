...
int Options::apply(int argc, char *argv[]) {
  ...
  while (process) {
    ...
    static struct option long_options[] = {
      ...
      {(char*)"format-csv", 0, 0, 'c'},
      {(char*)"format-sql", 0, 0, 's'},
      {(char*)"format-raw", 0, 0, 'r'},
      {(char*)"format-tdiff", 0, 0, 't'},
      {(char*)"format-index", 0, 0, 'i'},

      {(char*)"input-format", 1, 0, 0},
      {(char*)"output-format", 1, 0, 0},
      ...
      {(char*)"fixed-columns", 0, 0, 'F'},
      {(char*)"ignore-case", 0, 0, 'A'},

      {(char*)"ordered", 0, 0, '1'},
      {(char*)"unordered", 0, 0, '0'},
      ...
      {(char*)"output", 1, 0, 'o'},
      {(char*)"format-version", 1, 0, 'V'},
      {(char*)"parent", 1, 0, 'p'},
      {(char*)"input-formats", 0, 0, 'l'},
      {(char*)"help", 0, 0, 'h'},

      {(char*)"head-trimmed", 0, 0, 0},
      {(char*)"tail-trimmed", 0, 0, 0},
      {(char*)"fake", 0, 0, 0},
      {(char*)"inplace", 0, 0, 0},
      {(char*)"tmp", 1, 0, 0},
      {(char*)"patch", 1, 0, 0},
      ...
      {(char*)"version", 0, 0, 0},
      {(char*)"strict", 0, 0, 0},
      {(char*)"patch-formats", 0, 0, 0},
      {(char*)"default-table", 1, 0, 0},
      {(char*)"eol", 1, 0, 0},
      {(char*)"headerless", 0, 0, 0},
      {(char*)"paint", 0, 0, 0},
      {(char*)"scan-for-patch", 0, 0, 0},

      {(char*)"act", 1, 0, 0},

      {(char*)"help-doxygen", 0, 0, 0},
      {(char*)"test-file", 1, 0, 0},
